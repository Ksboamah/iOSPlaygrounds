...
let name = "Ryan"
let number = "60"
let adjective = "brand new"
let noun = "controller"
let place = "store"
let positiveEmotion = "excited"
let negativeEmotion = "disappionted"
let bigDayString = "Today was a big day for \(name). They had finally saved up \(number) dollars and were going to buy a \(adjective) \(noun). They went to the \(noun) \(place) feeling very \(positiveEmotion). But then they felt \(negativeEmotion). They were all out of \(noun)s!"
//:
//:
