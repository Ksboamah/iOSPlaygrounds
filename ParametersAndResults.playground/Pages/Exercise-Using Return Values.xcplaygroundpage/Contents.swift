...
func impossibleThingsPhrase(numberOfImpossibleThings: Int, meal: String) -> String {
    return "Why, I've believed as many as \(numberOfImpossibleThings) impossible things before \(meal)"
}

let totalNumberOfImpossibleThings = impossibleBeliefsCount(pigsFlying: 4, frogsBecomingPrinces: 3, multipleLightningStrikes: 7)
impossibleThingsPhrase(numberOfImpossibleThings: totalNumberOfImpossibleThings, meal: "teatime")
