...
func valentines(numberOfChocolates: Int, numberOfBundlesOfRoses: Int) -> String {
    let numberOfChocolatesPerBox = 4
    let boxOfChocolates = numberOfChocolates/numberOfChocolatesPerBox
    let numberOfRosesInBundle = 5
    let bouquet = numberOfBundlesOfRoses * numberOfRosesInBundle
    
    return "Your Valentines Day package includes \(boxOfChocolates) boxes of chocolates and a bouquet of \(bouquet) roses"
}

valentines(numberOfChocolates: 40, numberOfBundlesOfRoses: 6
)
