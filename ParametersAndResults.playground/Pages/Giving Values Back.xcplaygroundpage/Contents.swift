...
*/
func myFavorite(categoryOfThing: String, favorite: String) -> String {
...
myFavorite(categoryOfThing: "sports car", favorite: "Maserati")
...
"Hello, my name is Kwame. \(myFavorite(categoryOfThing: "song", favorite: "OTW by Khalid"))."
