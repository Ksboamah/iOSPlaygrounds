 ...
 */
var somePlace = GPS(longitude: 51.514004, latitude: 51.514004)
...
var favoriteBook = Book(titile: "Dear Martin", author: "Nic Strone", pages: 240, price: 9.99)
print(favoriteBook.author)
print(favoriteBook.titile)
 ...
 */
var myHeight = Height(heightInCentimeters: 180.34)
print(myHeight)
