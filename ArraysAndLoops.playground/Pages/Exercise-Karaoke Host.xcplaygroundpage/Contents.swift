 ...
 */
var songList = [String]()
songList.append("Terrified")
songList.append("Cyanide")
songList.append("Skybox")
 ...
 */
var enthusiasticSinger = ["Broke", "Pretty Little Fears", "Magic"]
songList += enthusiasticSinger
...
for songs in songList{
    print("Hey singer it's time to perform \(songs)")
}
