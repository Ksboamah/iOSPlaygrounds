...
*/
let totalStorageInMB = 8000
let currentPhoneStorageInMB = 3000
let sizeOfOneVideoInMB = 150
let numberOfVideosToFillPhone = (totalStorageInMB - currentPhoneStorageInMB) / sizeOfOneVideoInMB
